...
const proxyModule = buildModule("ProxyModule", (m) => {
    ...
    const initialize = m.encodeFunctionCall(talentirContractV2, "initialize", [deployer, deployer]);

    const proxy = m.contract("TransparentUpgradeableProxy", [talentirContractV2, deployer, initialize]);
