...
interface TalentirInterface extends ethers.utils.Interface {
  functions: {
    ...
    "tokenCidToTokenID(string)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "tokenCidToTokenID",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class Talentir extends BaseContract {
  ...
  tokenCidToTokenID(cid: string, overrides?: CallOverrides): Promise<BigNumber>;
